module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, fir.defaultkind = "a1c4d8i4l4r4", fir.kindmap = "", fir.relocation_model = 1 : i32, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.ident = "flang version 23.0.0 (https://github.com/llvm/llvm-project.git d24ebe3f00b35c14b64c06d88451c7556ccbc016)", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @_QQmain() attributes {fir.bindc_name = "TEST"} {
    ...
    %17 = fir.do_loop %arg0 = %13 to %15 step %c1 iter_args(%arg1 = %16) -> (i32) {
      ...
      %34 = fir.load %8 : !fir.ref<i32>
      %35 = fir.convert %34 : (i32) -> i64
      %36 = fir.array_coor %6(%5) %35 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      fir.store %33 to %36 : !fir.ref<i32>
      %37 = fir.convert %c1 : (index) -> i32
      %38 = fir.load %8 : !fir.ref<i32>
      %39 = arith.addi %38, %37 overflow<nsw> : i32
      fir.result %39 : i32
    }
    ...
    %22 = fir.do_loop %arg0 = %18 to %20 step %c1 iter_args(%arg1 = %21) -> (i32) {
      ...
      %35 = fir.array_coor %6(%5) %34 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      %36 = fir.load %35 : !fir.ref<i32>
      %37 = fir.load %8 : !fir.ref<i32>
      %38 = fir.convert %37 : (i32) -> i64
      %39 = fir.array_coor %3(%2) %38 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      fir.store %36 to %39 : !fir.ref<i32>
      %40 = fir.convert %c1 : (index) -> i32
      %41 = fir.load %8 : !fir.ref<i32>
      %42 = arith.addi %41, %40 overflow<nsw> : i32
      fir.result %42 : i32
    }
    ...
    %27 = fir.do_loop %arg0 = %23 to %25 step %c1 iter_args(%arg1 = %26) -> (i32) {
      fir.store %arg1 to %8 : !fir.ref<i32>
      %33 = fir.load %8 : !fir.ref<i32>
      %34 = arith.subi %33, %c1_i32 overflow<nsw> : i32
      %35 = fir.convert %34 : (i32) -> i64
      %36 = fir.array_coor %3(%2) %35 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      %37 = fir.load %36 : !fir.ref<i32>
      %38 = fir.load %8 : !fir.ref<i32>
      %39 = fir.convert %38 : (i32) -> i64
      %40 = fir.array_coor %3(%2) %39 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      fir.store %37 to %40 : !fir.ref<i32>
      %41 = fir.convert %c1 : (index) -> i32
      %42 = fir.load %8 : !fir.ref<i32>
      %43 = arith.addi %42, %41 overflow<nsw> : i32
      fir.result %43 : i32
    }
    fir.store %27 to %8 : !fir.ref<i32>
    fir.store %c0_i32 to %12 : !fir.ref<i32>
    %28 = fir.convert %c1_i32 : (i32) -> index
    %29 = fir.load %10 : !fir.ref<i32>
    %30 = fir.convert %29 : (i32) -> index
    %31 = fir.convert %28 : (index) -> i32
    %32 = fir.do_loop %arg0 = %28 to %30 step %c1 iter_args(%arg1 = %31) -> (i32) {
      fir.store %arg1 to %8 : !fir.ref<i32>
      %33 = fir.load %12 : !fir.ref<i32>
      %34 = fir.load %8 : !fir.ref<i32>
      %35 = fir.convert %34 : (i32) -> i64
      %36 = fir.array_coor %3(%2) %35 : (!fir.ref<!fir.array<10xi32>>, !fir.shape<1>, i64) -> !fir.ref<i32>
      %37 = fir.load %36 : !fir.ref<i32>
      %38 = arith.addi %33, %37 : i32
      fir.store %38 to %12 : !fir.ref<i32>
      %39 = fir.convert %c1 : (index) -> i32
      %40 = fir.load %8 : !fir.ref<i32>
      %41 = arith.addi %40, %39 overflow<nsw> : i32
      fir.result %41 : i32
    }
    fir.store %32 to %8 : !fir.ref<i32>
    return
  }
